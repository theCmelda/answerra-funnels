...
Source of truth is `~/Desktop/Answerra.ai funnels/funnels/` on the client's Mac. Currently deployed via `vercel deploy --prod` (CLI). To switch to GitHub-triggered deploys, link this repo to the Vercel `answerra-funnels` project.
